...
# tf.dtypes.cast(train_data, tf.float32)
# tf.dtypes.cast(train_label, tf.int16)

##
spectrogram = tf.signal.stft(train_data, frame_length=255, frame_step=128)
...
train_label = tf.expand_dims(train_label, -1)
print("\n******************************\n")
...
x = preprocessing.Resizing(32, 32)(input_vec)
